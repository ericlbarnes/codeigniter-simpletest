...
$controllers = directory_map(TESTS_DIR . 'controllers');
$models = directory_map(TESTS_DIR . 'models');
$views = directory_map(TESTS_DIR . 'views');
$libraries = directory_map(TESTS_DIR . 'libraries');
$bugs = directory_map(TESTS_DIR . 'bugs');
$helpers = directory_map(TESTS_DIR . 'helpers');
